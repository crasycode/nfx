    ...
    protected virtual void renderFooter() { defaultFooter(); }
     ...
     protected override void DoRender()
     {
      ...
      if(Context.GeoEntity!=null){
        ...
        Target.Write( Master._76_S_LITERAL_12 );
        Target.Write(Target.Encode( fn ));
        Target.Write( Master._76_S_LITERAL_13 );
      }
        Target.Write( Master._76_S_LITERAL_14 );

     }
    protected void defaultFooter()
    {
        Target.Write( Master._76_S_LITERAL_15 );
   ...
   <br />
     <div class=""tail"">
         ...
         This site is served by the <strong>NFX.Wave</strong> framework
          <br />
         Generated on "; 
        private const string _76_S_LITERAL_9 = @"  for "; 
        private const string _76_S_LITERAL_10 = @"
         "; 
        private const string _76_S_LITERAL_11 = @"
         from "; 
        private const string _76_S_LITERAL_12 = @" <img src=""/stock/site/flags/"; 
        private const string _76_S_LITERAL_13 = @".png"">
         "; 
        private const string _76_S_LITERAL_14 = @"
     </div>
 </body>
</html> 

"; 
        private const string _76_S_LITERAL_15 = @"
